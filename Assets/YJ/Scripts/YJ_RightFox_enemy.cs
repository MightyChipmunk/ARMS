...
public class YJ_RightFox_enemy : YJ_Hand_right
{
    Vector3 dir;
    float speed = 7f;
    ...
    YJ_RightFox_lazer_e yj_Rightfox_lazer;
    ...
    void Start()
    {
        ...
        yj_Rightfox_lazer = cylinder.GetComponent<YJ_RightFox_lazer_e>();
    ...
    void Update()
    {
        if (InputManager.Instance.EnemyFire2 && !fire)
        {
            // 필살기 감지
